...
Version  : 1.9.4
Release  : 11
URL      : file:///aot/build/clearlinux/packages/jsoncpp/jsoncpp-v1.9.4.tar.gz
Source0  : file:///aot/build/clearlinux/packages/jsoncpp/jsoncpp-v1.9.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627532557
mkdir -p clr-build
pushd clr-build
