...
Source0  : https://github.com/open-source-parsers/jsoncpp/archive/1.8.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1506437240
mkdir clr-build
pushd clr-build
